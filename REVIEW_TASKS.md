...
- [x] Use last activity/telemetry timestamp (not just `latitude`) to classify active vs. stale; avoid marking devices without location data as stale by default.
...
- [ ] Document the default staleness window and override path in `README.md` or `AGENTS.md` so ops understand how counts are derived.
